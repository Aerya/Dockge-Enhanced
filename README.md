...
- **📦 Volume backup** — The Restic backup tab now lets you include full Docker volume directories (`/app/data`, `/opt/stacks`) alongside the existing compose/env backups, with live folder size display.
