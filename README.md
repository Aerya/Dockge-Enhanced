...
| --- | --- |
| **Multi-instance** | Instance names, per-instance filtering, transactional copy/migration, resumable jobs, and automatic cold replication with no repository setup |
