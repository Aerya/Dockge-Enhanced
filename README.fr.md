...
| --- | --- |
| **Multi-instance** | Noms d'instances, filtre par instance, copie/migration transactionnelle, jobs reprenables et réplication froide automatique sans dépôt à configurer |
